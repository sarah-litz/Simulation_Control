...
logging.basicConfig(filename='/Users/sarahlitz/Projects/Donaldson Lab/RPI_Simulation_Control/Simulation_Control/Logging/eventlogging.log' , level=logging.DEBUG )
## -- ## 
cwd = os.getcwd() 
